...
Upload CSV and JSON files to a Maana cloud instance.
...
gql mload data -p test

# load a specific file
gql mload data/person.json -p test

# load a specifi file in batches with an explicit mutation
gql mload data/person.json -m addEmployees -b 1000
```
